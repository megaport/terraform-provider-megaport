...
resource "megaport_port" "port_3_sin" {
  product_name           = "Port 3 SIN"
  port_speed             = 10000
...
resource "megaport_port" "port_4_sin" {
  product_name           = "Port 4 SIN"
  port_speed             = 10000
  location_id            = data.megaport_location.location_2.id
  contract_term_months   = 1
  marketplace_visibility = false
...
resource "megaport_vxc" "port_4_sin_mcr_2_sin_vxc" {
  product_name         = "Port 3 SIN to MCR 2 SIN VXC"
  rate_limit           = 1000
  contract_term_months = 1
