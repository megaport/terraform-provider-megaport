...
- `local_asn` (Number) The local ASN of the BGP connection. When this end is an MCR, the API applies two rules on create and update. Leave it unset when peer_asn equals the MCR ASN. Otherwise it must differ from peer_asn.
