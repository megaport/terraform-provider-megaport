...
page_title: "megaport_lag_port Resource - megaport"
subcategory: ""
description: |-
...
- `port_speed` (Number) The speed of the port in Mbps. Can be 10000 (10G), 100000 (100G), or 400000 (400G) where available.
- `product_name` (String) The name of the LAG port.
