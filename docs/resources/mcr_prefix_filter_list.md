...
page_title: "megaport_mcr_prefix_filter_list Resource - megaport"
subcategory: ""
description: |-
...
- `address_family` (String) The IP address standard of the IP network addresses in the prefix filter list. Valid values are 'IPv4' and 'IPv6' (case-insensitive). Changing this value requires replacement.
...
- `prefix` (String) The network address of the prefix filter list entry in CIDR notation (e.g., '10.0.1.0/24'). Must be a valid network address with no host bits set (e.g., use '162.43.146.92/31' instead of '162.43.146.93/31').
