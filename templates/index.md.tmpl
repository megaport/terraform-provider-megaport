...
| `wait_time` | No | `10` | Minutes to wait for resources to finish provisioning during create and update, for a VXC to decommission during destroy, and for a VLAN that a destroyed VXC held to free before a VXC create or update reuses it. Minimum `1`. See [Provisioning Wait Time](#provisioning-wait-time). |
