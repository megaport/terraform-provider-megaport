		...
		Steps: []resource.TestStep{
			{
				...
				resource "megaport_mve" "mve" {
                  ...
                  }`, MVEArubaTestLocationIDNum, mveName, costCentre, mveName, mveKey),
			...
			// Data Source Testing
			{
				...
				}`, MVEArubaTestLocationIDNum, mveName, costCentre, mveName, mveKey, mveName),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("megaport_mve.mve", "product_name", mveName),
					resource.TestCheckResourceAttr("megaport_mve.mve", "cost_centre", costCentre),
			...
			// Update Testing
			{
				...
				resource "megaport_mve" "mve" {
                  ...
                  }`, MVEArubaTestLocationIDNum, mveNameNew, costCentreNew, mveName, mveKey),
				Check: resource.ComposeAggregateTestCheckFunc(
		...
		Steps: []resource.TestStep{
			{
				...
				}`, MVEArubaTestLocationIDNum, mveName, costCentreName, mveName, mveKey),
				Check: resource.ComposeAggregateTestCheckFunc(
			...
			},
			{
				...
				}`, MVEArubaTestLocationIDNum, mveName, mveName, mveKey),
				Check: resource.ComposeAggregateTestCheckFunc(
	...
	resource.Test(suite.T(), resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Data Source Testing
			{
				...
				}`, MVEVersaTestLocationIDNum, mveName, costCentre, mveName),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("megaport_mve.mve", "product_name", mveName),
					resource.TestCheckResourceAttr("megaport_mve.mve", "cost_centre", costCentre),
					resource.TestCheckResourceAttr("megaport_mve.mve", "vendor", "VERSA"),
