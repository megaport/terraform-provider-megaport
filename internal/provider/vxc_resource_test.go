...
// Make sure AENd VLAN does not change to 0 in update.  Make sure B-End Inner VLAN is Null
func (suite *VXCWithMVEProviderTestSuite) TestMVE_AWS_VXC_SameInnerAEndVLAN() {
	portName := RandomTestName()
	costCentreName := RandomTestName()
	mveName := RandomTestName()
	awsVXCName := RandomTestName()
