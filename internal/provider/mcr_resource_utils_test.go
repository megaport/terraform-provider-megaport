...
// newMegaportAPIError builds the *megaport.ErrorResponse the SDK returns for a non-2xx response.
...
// newMegaportAPIErrorWithData is newMegaportAPIError with .Data set.
